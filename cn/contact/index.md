...
<div class="form-group">
<label>您的需求或问题 / Request or Question</label>
<textarea name="message" rows="6" placeholder="请描述您的具体需求..." required></textarea>
</div>
<button type="submit" class="submit-btn">提交 / Submit</button>
</form>